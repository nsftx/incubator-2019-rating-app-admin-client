<template>
  <div id="today">
    ...
    <br>
    <div id="lineChart"><apexcharts type=area height=400 :options="diagramOptions" :series="diagramSeries"></apexcharts></div>
    <div id="pieChart"><apexcharts type=pie height=350 :options="chartOptions" :series="chartSeries"></apexcharts></div>
    <br>
    <div id="dataTable">
    <div id="tableData">
